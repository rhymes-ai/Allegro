...
from allegro.dataset.allegro_ti2v_datasets import AllegroTI2V_dataset
...
def getdataset(args):
    ...
    if args.dataset == 't2v':
        ...
        tokenizer = T5Tokenizer.from_pretrained(args.tokenizer, cache_dir=args.cache_dir)
        return AllegroTI2V_dataset(args, transform=transform, temporal_sample=temporal_sample, tokenizer=tokenizer)
